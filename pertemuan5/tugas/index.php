...
//untuk menghubungkan ke database yang sudah disetting di koneksi.php
    ...
    $get1= mysqli_query($conn, "SELECT * FROM data");
    // untuk menghitung data secara otomatis 
        ...
        <div class="row"> 
            ...
            <div class="col-lg-6">
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <!-- bagde untuk menyisipkan tampilan banyaknya data di dalam form -->
                    <span class="position-relative px-2  bg-secondary badge rounded-circle text-white">
                            <span class="visually-hidden"><?=$count1;?></span>
                    </span>
                </h4>
